<template>
  <div class="crud-opts">
    <span class="crud-opts-left">
      ...
      <el-button
        v-if="crud.optShow.download && showExport"
...
export default {
  ...
  props: {
    ...
    showExport: { // 新增 showExport prop
      type: Boolean,
      default: true
    },
    showAdd: { // 新增 showExport prop
      type: Boolean,
      default: true
    },
    showEdit: {
